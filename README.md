...
| <a name="output_artifact_package"></a> [artifact\_package](#output\_artifact\_package) | The Artifact package in Azure DevOps | `"null"` | no |
| <a name="output_board_column"></a> [board\_column](#output\_board\_column) | The Board column in Azure DevOps | `"null"` | no |
| <a name="output_board_swimlane"></a> [board\_swimlane](#output\_board\_swimlane) | The Board swimlane in Azure DevOps | `"null"` | no |
...
| <a name="output_dashboard"></a> [dashboard](#output\_dashboard) | The Dashboard in Azure DevOps | `"null"` | no |
| <a name="output_deployment_group"></a> [deployment\_group](#output\_deployment\_group) | The Deployment group in Azure DevOps | `"null"` | no |
...
| <a name="output_environment_kubernetes_resource"></a> [environment\_kubernetes\_resource](#output\_environment\_kubernetes\_resource) | The Environment Kubernetes resource in Azure DevOps | `"null"` | no |
...
| <a name="output_feed"></a> [feed](#output\_feed) | The Artifact feed in Azure DevOps | `"null"` | no |
...
| <a name="output_iteration_path"></a> [iteration\_path](#output\_iteration\_path) | The Iteration path in Azure DevOps | `"null"` | no |
| <a name="output_organization"></a> [organization](#output\_organization) | The Organization in Azure DevOps | `"null"` | no |
| <a name="output_pipeline_job"></a> [pipeline\_job](#output\_pipeline\_job) | The Pipeline job in Azure DevOps | `"null"` | no |
| <a name="output_pipeline_matrix"></a> [pipeline\_matrix](#output\_pipeline\_matrix) | The Pipeline matrix in Azure DevOps | `"null"` | no |
| <a name="output_pipeline_stage"></a> [pipeline\_stage](#output\_pipeline\_stage) | The Pipeline stage in Azure DevOps | `"null"` | no |
| <a name="output_pipeline_variable"></a> [pipeline\_variable](#output\_pipeline\_variable) | The Pipeline variable in Azure DevOps | `"null"` | no |
| <a name="output_process"></a> [process](#output\_process) | The Process in Azure DevOps | `"null"` | no |
...
| <a name="output_security_group"></a> [security\_group](#output\_security\_group) | The Security group in Azure DevOps | `"null"` | no |
...
| <a name="output_serviceendpoint_azure_service_bus"></a> [serviceendpoint\_azure\_service\_bus](#output\_serviceendpoint\_azure\_service\_bus) | The Azure Service Bus service endpoint in Azure DevOps | `"null"` | no |
...
| <a name="output_serviceendpoint_black_duck"></a> [serviceendpoint\_black\_duck](#output\_serviceendpoint\_black\_duck) | The Black Duck service endpoint in Azure DevOps | `"null"` | no |
| <a name="output_serviceendpoint_checkmarx_one"></a> [serviceendpoint\_checkmarx\_one](#output\_serviceendpoint\_checkmarx\_one) | The Checkmarx One service endpoint in Azure DevOps | `"null"` | no |
| <a name="output_serviceendpoint_checkmarx_sast"></a> [serviceendpoint\_checkmarx\_sast](#output\_serviceendpoint\_checkmarx\_sast) | The Checkmarx SAST service endpoint in Azure DevOps | `"null"` | no |
| <a name="output_serviceendpoint_checkmarx_sca"></a> [serviceendpoint\_checkmarx\_sca](#output\_serviceendpoint\_checkmarx\_sca) | The Checkmarx SCA service endpoint in Azure DevOps | `"null"` | no |
...
| <a name="output_serviceendpoint_dynamics_lifecycle_services"></a> [serviceendpoint\_dynamics\_lifecycle\_services](#output\_serviceendpoint\_dynamics\_lifecycle\_services) | The Dynamics Lifecycle Services service endpoint in Azure DevOps | `"null"` | no |
...
| <a name="output_serviceendpoint_generic_v2"></a> [serviceendpoint\_generic\_v2](#output\_serviceendpoint\_generic\_v2) | The Generic v2 service endpoint in Azure DevOps | `"null"` | no |
...
| <a name="output_serviceendpoint_gitlab"></a> [serviceendpoint\_gitlab](#output\_serviceendpoint\_gitlab) | The GitLab service endpoint in Azure DevOps | `"null"` | no |
...
| <a name="output_serviceendpoint_openshift"></a> [serviceendpoint\_openshift](#output\_serviceendpoint\_openshift) | The OpenShift service endpoint in Azure DevOps | `"null"` | no |
...
| <a name="output_serviceendpoint_snyk"></a> [serviceendpoint\_snyk](#output\_serviceendpoint\_snyk) | The Snyk service endpoint in Azure DevOps | `"null"` | no |
...
| <a name="output_serviceendpoint_visualstudiomarketplace"></a> [serviceendpoint\_visualstudiomarketplace](#output\_serviceendpoint\_visualstudiomarketplace) | The Visual Studio Marketplace service endpoint in Azure DevOps | `"null"` | no |
...
| <a name="output_variable_group_variable"></a> [variable\_group\_variable](#output\_variable\_group\_variable) | The Variable group variable in Azure DevOps | `"null"` | no |
| <a name="output_wiki"></a> [wiki](#output\_wiki) | The Wiki in Azure DevOps | `"null"` | no |
| <a name="output_wiki_page"></a> [wiki\_page](#output\_wiki\_page) | The Wiki page in Azure DevOps | `"null"` | no |
| <a name="output_workitem"></a> [workitem](#output\_workitem) | The Work item in Azure DevOps | `"null"` | no |
| <a name="output_workitemquery"></a> [workitemquery](#output\_workitemquery) | The Work item query in Azure DevOps | `"null"` | no |
| <a name="output_workitemquery_folder"></a> [workitemquery\_folder](#output\_workitemquery\_folder) | The Work item query folder in Azure DevOps | `"null"` | no |
| <a name="output_workitemtracking_field"></a> [workitemtracking\_field](#output\_workitemtracking\_field) | The Work item tracking field in Azure DevOps | `"null"` | no |
| <a name="output_workitemtrackingprocess_field"></a> [workitemtrackingprocess\_field](#output\_workitemtrackingprocess\_field) | The Work item tracking process field in Azure DevOps | `"null"` | no |
| <a name="output_workitemtrackingprocess_group"></a> [workitemtrackingprocess\_group](#output\_workitemtrackingprocess\_group) | The Work item tracking process group in Azure DevOps | `"null"` | no |
| <a name="output_workitemtrackingprocess_page"></a> [workitemtrackingprocess\_page](#output\_workitemtrackingprocess\_page) | The Work item tracking process page in Azure DevOps | `"null"` | no |
| <a name="output_workitemtrackingprocess_process"></a> [workitemtrackingprocess\_process](#output\_workitemtrackingprocess\_process) | The Work item tracking process in Azure DevOps | `"null"` | no |
| <a name="output_workitemtrackingprocess_state"></a> [workitemtrackingprocess\_state](#output\_workitemtrackingprocess\_state) | The Work item tracking process state in Azure DevOps | `"null"` | no |
| <a name="output_workitemtrackingprocess_workitemtype"></a> [workitemtrackingprocess\_workitemtype](#output\_workitemtrackingprocess\_workitemtype) | The Work item tracking process work item type in Azure DevOps | `"null"` | no |
