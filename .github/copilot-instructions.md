...
- Config: `.terraform-terraform-docs.yml` and `.readme-terraform-docs.yml`
...
- Linter, formatter, and terraform-docs configuration files live at the repository root (e.g. `.cspell.json`, `.markdownlint.json`, `.mega-linter.yml`, `.readme-terraform-docs.yml`, `.terraform-terraform-docs.yml`).
